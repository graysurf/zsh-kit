...
This repo no longer ships the legacy Zsh implementation of `fzf-tools`.
`fzf-tools` is now expected to be provided by a **native binary** (Rust) installed on your `PATH`.
